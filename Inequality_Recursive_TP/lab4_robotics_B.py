...
class Task:
    ...
    def setFF(self, value):
        self.ff = np.ones(self.sigma_d.shape)*value
...
class Position2D(Task):
    def __init__(self, name, desired, link = 3):
        ...
        self.ff = np.zeros(desired.shape) #(2,1)
        self.K = np.eye(len(desired)) #(2,2)
...
class Orientation2D(Task):
    def __init__(self, name, desired, link = 3):
        ...
        self.ff = np.zeros(desired.shape) # feedforward vel
        self.K = np.eye(len(desired)) # K  
...
class Configuration2D(Task):
    def __init__(self, name, desired, link = 3):
        ...
        self.ff = np.zeros(desired.shape)  
